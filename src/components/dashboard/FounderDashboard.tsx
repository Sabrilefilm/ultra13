  ...
  return <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Card className="p-4 space-y-8">
        <div className="flex items-center justify-between">
          ...
          <Button variant="ghost" size="icon" onClick={() => onOpenLiveSchedule(username)}>
            <CalendarDays className="h-5 w-5" />
          </Button>
        </div>
        <Button variant="outline" className="w-full" onClick={() => onScheduleMatch()}>
          Programmer un match
        </Button>
      </Card>
      ...
      <Card className="p-4 space-y-8">
        <div className="flex items-center justify-between">
          ...
          <Button variant="ghost" size="icon" onClick={onConfigureRewards}>
            <TrendingUp className="h-5 w-5" />
          </Button>
        </div>
        <Button variant="outline" className="w-full" onClick={onConfigureRewards}>
