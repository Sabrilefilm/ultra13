...
export const MatchTimer: React.FC<MatchTimerProps> = ({ 
  ...
  return (
    <div className="flex flex-col items-center space-y-2 p-2 border rounded-lg bg-white/50 dark:bg-slate-800/50 shadow-sm">
      ...
      <div className="flex space-x-2">
        <button 
          ...
          className="text-xs px-2 py-1 rounded bg-purple-100 hover:bg-purple-200 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300 dark:hover:bg-purple-800/50"
        >
          {isPaused ? 'Reprendre' : 'Pause'}
        </button>
        <button 
          onClick={() => setSecondsLeft(initialMinutes * 60)}
          className="text-xs px-2 py-1 rounded bg-blue-100 hover:bg-blue-200 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-800/50"
        >
          Réinitialiser
        </button>
      </div>
