...
export const TransferEmptyState: React.FC<TransferEmptyStateProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-6 sm:py-12">
      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center mb-3">
      ...
      {role === 'creator' && (
        <Button 
          ...
          variant="outline" 
          size="sm"
          className="mt-2 border-purple-300 dark:border-purple-700 text-purple-700 dark:text-purple-300 text-xs"
        >
