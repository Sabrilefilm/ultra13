...
const Penalties = () => {
  ...
  const getPenaltyTypeLabel = (type) => {
    switch (type) {
      ...
      case 'content': return 'Contenu inapproprié';
      case 'match_absence': return 'Absence match';
      default: return type;
    }
  };
  ...
  const getPenaltyTypeColor = (type) => {
    switch (type) {
      case 'absence': return 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300';
      ...
      case 'content': return 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300';
      case 'match_absence': return 'bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-300';
    ...
    <SidebarProvider defaultOpen={true}>
      ...
      <div className="p-6 md:ml-64 space-y-6">
        <Card className="bg-white dark:bg-slate-900 shadow-lg border-purple-100 dark:border-purple-900/30">
          <CardHeader className="flex flex-row items-center justify-between pb-2 bg-gradient-to-r from-purple-50 to-white dark:from-purple-950/30 dark:to-slate-950">
            ...
            {canAddPenalty && (
              <Button
                onClick={() => setShowAddPenaltyDialog(true)}
            ...
            {loadingPenalties ? (
                        ...
                        <TableCell>
                          <div className="flex space-x-2">
                            ...
                            <Button 
                              variant="outline" 
                              size="sm"
                              className="text-gray-600 border-gray-300 hover:bg-gray-50 dark:hover:bg-gray-900"
                            >
              ...
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm text-center max-w-md">
                  {role === 'creator' 
                    ? "Vous n'avez pas de pénalités actives. Continuez comme ça!" 
                    : "Aucune pénalité n'a été attribuée pour le moment."}
                </p>
