          ...
          <div className="flex-1 p-6 overflow-auto">
            <div className="max-w-7xl mx-auto space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-8">
                {/* Tableau créateur débutant */}
                <Card className="bg-white dark:bg-gray-800 border border-blue-100 dark:border-blue-900/20 shadow-lg overflow-hidden">
                  ...
                  <CardHeader className="bg-blue-100 dark:bg-blue-900/20 p-4">
                    <CardTitle className="text-center">
                      CRÉATEUR <span className="text-red-600 font-extrabold">DÉBUTANT</span>
                    </CardTitle>
                  </CardHeader>
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <th className="py-3 px-4 text-left">Diamants Requis</th>
                          <th className="py-3 px-4 text-right">CADEAUX</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <td className="py-3 px-4">36 000 - 75 000</td>
                          <td className="py-3 px-4 text-right font-medium">10 € - 30 €</td>
                        </tr>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                        ...
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          ...
                          <td className="py-3 px-4 text-right font-medium">130 €</td>
                        </tr>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <td className="py-3 px-4">300 000</td>
                          <td className="py-3 px-4 text-right font-medium">180 €</td>
                        </tr>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <td className="py-3 px-4">400 000</td>
                          <td className="py-3 px-4 text-right font-medium">250 €</td>
                        </tr>
                        <tr>
                          <td className="py-3 px-4">500 000 - 600 000</td>
                          <td className="py-3 px-4 text-right font-medium">300 € - 400 €</td>
                        </tr>
                      </tbody>
                    </table>
                  </CardContent>
                ...
                <Card className="bg-white dark:bg-gray-800 border border-blue-100 dark:border-blue-900/20 shadow-lg overflow-hidden">
                  ...
                  <CardHeader className="bg-blue-100 dark:bg-blue-900/20 p-4">
                    <CardTitle className="text-center">
                      CRÉATEUR <span className="text-red-600 font-extrabold">NON-DÉBUTANT</span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="p-0">
                    <table className="w-full">
                      ...
                      <tbody>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <td className="py-3 px-4">150 000 - 350 000</td>
                          <td className="py-3 px-4 text-right font-medium">50 €</td>
                        </tr>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <td className="py-3 px-4">350 000 - 450 000</td>
                          <td className="py-3 px-4 text-right font-medium">100 €</td>
                        </tr>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <td className="py-3 px-4">450 000 - 550 000</td>
                          <td className="py-3 px-4 text-right font-medium">200 €</td>
                        </tr>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <td className="py-3 px-4">550 000 - 650 000</td>
                          <td className="py-3 px-4 text-right font-medium">300 €</td>
                        </tr>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <td className="py-3 px-4">650 000 - 750 000</td>
                          <td className="py-3 px-4 text-right font-medium">400 €</td>
                        </tr>
                        <tr>
                          <td className="py-3 px-4">750 000 - 850 000</td>
